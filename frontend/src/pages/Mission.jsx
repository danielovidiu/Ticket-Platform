...
export default function Mission() {
  return (
    <div className="max-w-[1000px] mx-auto px-6 md:px-10 py-24">
      <div className="font-mono-x text-xs uppercase tracking-[0.3em] text-ink-4">Manifesto · 01</div>
      ...
      <div className="mt-12 space-y-8 text-ink-2 text-lg leading-relaxed max-w-2xl">
